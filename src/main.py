...
from src.api import auth, materials, inventory, movements, labels, density_presets, purchase_orders, excel_viewer, production_schedule, material_management, material_groups, inspections, analytics, repository_check
...
app.include_router(repository_check.router, tags=["リポジトリチェック"])
